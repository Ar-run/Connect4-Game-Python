...
def select_difficulty():
    while True:
        difficulty = input("Select difficulty mode (easy, medium, hard): ").lower()
        if difficulty in ['easy', 'medium', 'hard']:
            return difficulty
        else:
            print("Invalid difficulty mode. Please choose again.")
...
play_first = choose_first_move()
if play_first:
    print("You'll start the game!")
else:
    print("Computer will start the game!")

turn = PLAYER if play_first else AI
